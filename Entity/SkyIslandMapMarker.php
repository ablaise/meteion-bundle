 ...
 * SkyIslandMapMarker.
 *
 * @ORM\Table(name="sky_island_map_marker")
 * @ORM\Entity
 */
class SkyIslandMapMarker
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="sky_island_map_marker_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
