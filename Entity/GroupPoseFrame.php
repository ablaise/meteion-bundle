 ...
 * GroupPoseFrame.
 *
 * @ORM\Table(name="group_pose_frame")
 * @ORM\Entity
 */
class GroupPoseFrame
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="group_pose_frame_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
     ...
     * @var string|null
     *
     * @ORM\Column(name="grid_text", type="string", length=255, nullable=true)
     */
    private $gridText;
    ...
    public function getGridText(): ?string
    {
        return $this->gridText;
    }

    public function setGridText(?string $gridText): self
    {
