 ...
 * MjicraftworksObject.
 *
 * @ORM\Table(name="mjicraftworks_object")
 * @ORM\Entity
 */
class MjicraftworksObject
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="mjicraftworks_object_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
