 ...
 * LfgextensionContent.
 *
 * @ORM\Table(name="lfgextension_content")
 * @ORM\Entity
 */
class LfgextensionContent
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="lfgextension_content_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
