 ...
 *
 * @ORM\Table(name="mjicraftworks_supply_define")
 * @ORM\Entity
 */
class MjicraftworksSupplyDefine
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="mjicraftworks_supply_define_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
