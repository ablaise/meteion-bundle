 ...
 * WeddingFlowerColor.
 *
 * @ORM\Table(name="wedding_flower_color")
 * @ORM\Entity
 */
class WeddingFlowerColor
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="wedding_flower_color_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
