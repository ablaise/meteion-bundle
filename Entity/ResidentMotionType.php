 ...
 * ResidentMotionType.
 *
 * @ORM\Table(name="resident_motion_type")
 * @ORM\Entity
 */
class ResidentMotionType
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="resident_motion_type_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
