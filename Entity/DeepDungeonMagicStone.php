 ...
 *
 * @ORM\Table(name="deep_dungeon_magic_stone")
 * @ORM\Entity
 */
class DeepDungeonMagicStone
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="deep_dungeon_magic_stone_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
