 ...
 * GoldSaucerTalk.
 *
 * @ORM\Table(name="gold_saucer_talk")
 * @ORM\Entity
 */
class GoldSaucerTalk
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="gold_saucer_talk_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_18", type="string", length=4009, nullable=true)
     */
    private $column18;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_19", type="string", length=4009, nullable=true)
     */
    private $column19;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_20", type="string", length=4009, nullable=true)
     */
    private $column20;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_21", type="string", length=4009, nullable=true)
     */
    private $column21;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_22", type="string", length=4009, nullable=true)
     */
    private $column22;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_23", type="string", length=4009, nullable=true)
     */
    private $column23;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_24", type="string", length=4009, nullable=true)
     */
    private $column24;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_25", type="string", length=4009, nullable=true)
     */
    private $column25;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_26", type="string", length=4009, nullable=true)
     */
    private $column26;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_27", type="string", length=4009, nullable=true)
     */
    private $column27;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_28", type="string", length=4009, nullable=true)
     */
    private $column28;
