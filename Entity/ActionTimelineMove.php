 ...
 * ActionTimelineMove.
 *
 * @ORM\Table(name="action_timeline_move")
 * @ORM\Entity
 */
class ActionTimelineMove
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="action_timeline_move_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
