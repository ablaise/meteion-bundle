 ...
 *
 * @ORM\Table(name="snipe_performance_camera")
 * @ORM\Entity
 */
class SnipePerformanceCamera
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="snipe_performance_camera_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
