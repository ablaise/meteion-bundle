 ...
 *
 * @ORM\Table(name="player_search_sub_location")
 * @ORM\Entity
 */
class PlayerSearchSubLocation
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="player_search_sub_location_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
