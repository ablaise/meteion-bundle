 ...
 *
 * @ORM\Table(name="ex_hotbar_crossbar_index_type")
 * @ORM\Entity
 */
class ExHotbarCrossbarIndexType
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="ex_hotbar_crossbar_index_type_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
