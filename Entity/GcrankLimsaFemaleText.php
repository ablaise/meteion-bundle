 ...
 *
 * @ORM\Table(name="gcrank_limsa_female_text")
 * @ORM\Entity
 */
class GcrankLimsaFemaleText
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="gcrank_limsa_female_text_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
