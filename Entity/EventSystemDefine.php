 ...
 * EventSystemDefine.
 *
 * @ORM\Table(name="event_system_define")
 * @ORM\Entity
 */
class EventSystemDefine
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="event_system_define_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
