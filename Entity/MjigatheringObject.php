 ...
 * MjigatheringObject.
 *
 * @ORM\Table(name="mjigathering_object")
 * @ORM\Entity
 */
class MjigatheringObject
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="mjigathering_object_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
