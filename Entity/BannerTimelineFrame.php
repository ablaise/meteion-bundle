 ...
 * BannerTimelineFrame.
 *
 * @ORM\Table(name="banner_timeline_frame")
 * @ORM\Entity
 */
class BannerTimelineFrame
{
    /**
     * @var string
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="banner_timeline_frame_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
