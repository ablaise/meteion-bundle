 ...
 * CollisionIdPallet.
 *
 * @ORM\Table(name="collision_id_pallet")
 * @ORM\Entity
 */
class CollisionIdPallet
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="collision_id_pallet_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
