 ...
 *
 * @ORM\Table(name="spearfishing_combo_target")
 * @ORM\Entity
 */
class SpearfishingComboTarget
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="spearfishing_combo_target_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
