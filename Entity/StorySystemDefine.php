 ...
 * StorySystemDefine.
 *
 * @ORM\Table(name="story_system_define")
 * @ORM\Entity
 */
class StorySystemDefine
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="story_system_define_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
