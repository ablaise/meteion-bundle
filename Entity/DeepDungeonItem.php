 ...
 * DeepDungeonItem.
 *
 * @ORM\Table(name="deep_dungeon_item", indexes={@ORM\Index(name="idx_3f2c540d47cc8c92", columns={"action"})})
 * @ORM\Entity
 */
class DeepDungeonItem
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="deep_dungeon_item_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
