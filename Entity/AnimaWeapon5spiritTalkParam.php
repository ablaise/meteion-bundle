 ...
 *
 * @ORM\Table(name="anima_weapon5spirit_talk_param")
 * @ORM\Entity
 */
class AnimaWeapon5spiritTalkParam
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="anima_weapon5spirit_talk_param_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
