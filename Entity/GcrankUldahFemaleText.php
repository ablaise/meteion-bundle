 ...
 *
 * @ORM\Table(name="gcrank_uldah_female_text")
 * @ORM\Entity
 */
class GcrankUldahFemaleText
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="gcrank_uldah_female_text_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
