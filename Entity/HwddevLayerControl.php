 ...
 * HwddevLayerControl.
 *
 * @ORM\Table(name="hwddev_layer_control")
 * @ORM\Entity
 */
class HwddevLayerControl
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="hwddev_layer_control_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
