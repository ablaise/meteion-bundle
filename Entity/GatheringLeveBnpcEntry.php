 ...
 *
 * @ORM\Table(name="gathering_leve_bnpc_entry")
 * @ORM\Entity
 */
class GatheringLeveBnpcEntry
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="gathering_leve_bnpc_entry_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
