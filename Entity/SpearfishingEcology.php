 ...
 * SpearfishingEcology.
 *
 * @ORM\Table(name="spearfishing_ecology")
 * @ORM\Entity
 */
class SpearfishingEcology
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="spearfishing_ecology_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
