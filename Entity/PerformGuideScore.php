 ...
 * PerformGuideScore.
 *
 * @ORM\Table(name="perform_guide_score")
 * @ORM\Entity
 */
class PerformGuideScore
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="perform_guide_score_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
