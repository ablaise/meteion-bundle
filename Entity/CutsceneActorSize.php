 ...
 * CutsceneActorSize.
 *
 * @ORM\Table(name="cutscene_actor_size")
 * @ORM\Entity
 */
class CutsceneActorSize
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="cutscene_actor_size_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
