 ...
 * GuildOrderMetadata.
 *
 * @ORM\Table(name="guild_order_metadata")
 * @ORM\Entity
 */
class GuildOrderMetadata
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="guild_order_metadata_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
