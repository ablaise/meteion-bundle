...
class GimmickTalk
{
     ...
     * @ORM\SequenceGenerator(sequenceName="gimmick_talk_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_3", type="string", length=710, nullable=true)
     */
    private $column3;
