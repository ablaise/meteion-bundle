...
class ExtraCommand
{
     ...
     * @ORM\SequenceGenerator(sequenceName="extra_command_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_1", type="string", length=599, nullable=true)
     */
    private $column1;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_2", type="string", length=599, nullable=true)
     */
    private $column2;
