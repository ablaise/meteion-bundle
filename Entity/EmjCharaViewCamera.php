 ...
 * EmjCharaViewCamera.
 *
 * @ORM\Table(name="emj_chara_view_camera")
 * @ORM\Entity
 */
class EmjCharaViewCamera
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="emj_chara_view_camera_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
