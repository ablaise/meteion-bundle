 ...
 * GoldSaucerContent.
 *
 * @ORM\Table(name="gold_saucer_content")
 * @ORM\Entity
 */
class GoldSaucerContent
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="gold_saucer_content_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
