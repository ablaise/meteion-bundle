 ...
 *
 * @ORM\Table(name="ride_shooting_scheduler")
 * @ORM\Entity
 */
class RideShootingScheduler
{
    /**
     * @var string
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="ride_shooting_scheduler_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
