 ...
 * PreHandlerMovement.
 *
 * @ORM\Table(name="pre_handler_movement")
 * @ORM\Entity
 */
class PreHandlerMovement
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="pre_handler_movement_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
