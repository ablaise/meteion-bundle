 ...
 * CreditBackImage.
 *
 * @ORM\Table(name="credit_back_image")
 * @ORM\Entity
 */
class CreditBackImage
{
    /**
     * @var string
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="credit_back_image_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
     ...
     * @var int|null
     *
     * @ORM\Column(name="back_image", type="integer", nullable=true)
     */
    private $backImage;
    ...
    public function setBackImage(?int $backImage): self
    {
