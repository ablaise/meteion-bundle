 ...
 * TripleTriadCard.
 *
 * @ORM\Table(name="triple_triad_card")
 * @ORM\Entity
 */
class TripleTriadCard
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="triple_triad_card_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
     ...
     * @var string|null
     *
     * @ORM\Column(name="name", type="string", length=1564, nullable=true)
     */
    private $name;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_3", type="string", length=1564, nullable=true)
     */
    private $column3;
     ...
     * @var string|null
     *
     * @ORM\Column(name="description", type="string", length=1564, nullable=true)
     */
    private $description;
