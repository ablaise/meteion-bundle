 ...
 * FittingShopCategory.
 *
 * @ORM\Table(name="fitting_shop_category")
 * @ORM\Entity
 */
class FittingShopCategory
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="fitting_shop_category_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
