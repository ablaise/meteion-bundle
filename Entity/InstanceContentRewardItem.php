 ...
 *
 * @ORM\Table(name="instance_content_reward_item")
 * @ORM\Entity
 */
class InstanceContentRewardItem
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="instance_content_reward_item_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
