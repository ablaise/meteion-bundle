 ...
 *
 * @ORM\Table(name="triple_triad_card_obtain")
 * @ORM\Entity
 */
class TripleTriadCardObtain
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="triple_triad_card_obtain_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
