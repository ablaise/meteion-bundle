 ...
 *
 * @ORM\Table(name="content_tourism_construct")
 * @ORM\Entity
 */
class ContentTourismConstruct
{
    /**
     * @var string
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="content_tourism_construct_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
