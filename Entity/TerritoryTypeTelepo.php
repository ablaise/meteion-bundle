 ...
 * TerritoryTypeTelepo.
 *
 * @ORM\Table(name="territory_type_telepo")
 * @ORM\Entity
 */
class TerritoryTypeTelepo
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="territory_type_telepo_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
