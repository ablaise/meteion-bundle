 ...
 *
 * @ORM\Table(name="director_system_define")
 * @ORM\Entity
 */
class DirectorSystemDefine
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="director_system_define_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
