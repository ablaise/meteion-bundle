 ...
 *
 * @ORM\Table(name="pv_pinitial_select_action_trait")
 * @ORM\Entity
 */
class PvPinitialSelectActionTrait
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="pv_pinitial_select_action_trait_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
