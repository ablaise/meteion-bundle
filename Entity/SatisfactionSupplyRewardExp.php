 ...
 *
 * @ORM\Table(name="satisfaction_supply_reward_exp")
 * @ORM\Entity
 */
class SatisfactionSupplyRewardExp
{
    /**
     * @var string
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="satisfaction_supply_reward_exp_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
