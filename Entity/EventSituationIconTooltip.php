 ...
 *
 * @ORM\Table(name="event_situation_icon_tooltip")
 * @ORM\Entity
 */
class EventSituationIconTooltip
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="event_situation_icon_tooltip_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
