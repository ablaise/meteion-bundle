 ...
 * HwddevLevelWebText.
 *
 * @ORM\Table(name="hwddev_level_web_text")
 * @ORM\Entity
 */
class HwddevLevelWebText
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="hwddev_level_web_text_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
