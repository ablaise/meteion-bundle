 ...
 *
 * @ORM\Table(name="gcrank_gridania_female_text")
 * @ORM\Entity
 */
class GcrankGridaniaFemaleText
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="gcrank_gridania_female_text_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
