 ...
 *
 * @ORM\Table(name="quest_battle_system_define")
 * @ORM\Entity
 */
class QuestBattleSystemDefine
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="quest_battle_system_define_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
