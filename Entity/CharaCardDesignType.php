 ...
 * CharaCardDesignType.
 *
 * @ORM\Table(name="chara_card_design_type")
 * @ORM\Entity
 */
class CharaCardDesignType
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="chara_card_design_type_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
