 ...
 *
 * @ORM\Table(name="triple_triad_tournament")
 * @ORM\Entity
 */
class TripleTriadTournament
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="triple_triad_tournament_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
