 ...
 * RideShootingTarget.
 *
 * @ORM\Table(name="ride_shooting_target")
 * @ORM\Entity
 */
class RideShootingTarget
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="ride_shooting_target_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
