 ...
 *
 * @ORM\Table(name="contents_note_category")
 * @ORM\Entity
 */
class ContentsNoteCategory
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="contents_note_category_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
