 ...
 * InstanceContentType.
 *
 * @ORM\Table(name="instance_content_type")
 * @ORM\Entity
 */
class InstanceContentType
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="instance_content_type_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
