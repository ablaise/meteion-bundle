 ...
 * CharaCardDecoration.
 *
 * @ORM\Table(name="chara_card_decoration")
 * @ORM\Entity
 */
class CharaCardDecoration
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="chara_card_decoration_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
