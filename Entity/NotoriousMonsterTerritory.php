 ...
 *
 * @ORM\Table(name="notorious_monster_territory")
 * @ORM\Entity
 */
class NotoriousMonsterTerritory
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="notorious_monster_territory_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
