 ...
 * ReactionEventObject.
 *
 * @ORM\Table(name="reaction_event_object")
 * @ORM\Entity
 */
class ReactionEventObject
{
    /**
     * @var string
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="reaction_event_object_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
