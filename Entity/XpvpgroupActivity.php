 ...
 * XpvpgroupActivity.
 *
 * @ORM\Table(name="xpvpgroup_activity")
 * @ORM\Entity
 */
class XpvpgroupActivity
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="xpvpgroup_activity_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_1", type="string", length=758, nullable=true)
     */
    private $column1;
