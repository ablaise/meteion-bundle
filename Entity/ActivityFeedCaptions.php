 ...
 *
 * @ORM\Table(name="activity_feed_captions")
 * @ORM\Entity
 */
class ActivityFeedCaptions
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="activity_feed_captions_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
