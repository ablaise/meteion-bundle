...
/**
 * MjicraftworksSupplyType.
 *
 * @ORM\Table(name="mjicraftworks_supply_type")
 * @ORM\Entity
 */
class MjicraftworksSupplyType
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="mjicraftworks_supply_type_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
