 ...
 * TerritoryChatRule.
 *
 * @ORM\Table(name="territory_chat_rule")
 * @ORM\Entity
 */
class TerritoryChatRule
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="territory_chat_rule_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
