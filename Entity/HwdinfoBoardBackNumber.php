 ...
 *
 * @ORM\Table(name="hwdinfo_board_back_number")
 * @ORM\Entity
 */
class HwdinfoBoardBackNumber
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="hwdinfo_board_back_number_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
