 ...
 *
 * @ORM\Table(name="benchmark_cut_scene_table")
 * @ORM\Entity
 */
class BenchmarkCutSceneTable
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="benchmark_cut_scene_table_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
