 ...
 *
 * @ORM\Table(name="description_stand_alone_transient")
 * @ORM\Entity
 */
class DescriptionStandAloneTransient
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="description_stand_alone_transient_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
