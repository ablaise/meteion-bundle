 ...
 * CompanyLeve.
 *
 * @ORM\Table(name="company_leve", indexes={@ORM\Index(name="idx_1978cf256c76294e", columns={"items_involved_2"}), @ORM\Index(name="idx_1978cf25dd4d30f0", columns={"bnpc_name_0"}), @ORM\Index(name="idx_1978cf25ad27c47f", columns={"bnpc_name_5"}), @ORM\Index(name="idx_1978cf256b1bed57", columns={"items_involved_6"}), @ORM\Index(name="idx_1978cf25334351dc", columns={"bnpc_name_2"}), @ORM\Index(name="idx_1978cf251b7119d8", columns={"items_involved_3"}), @ORM\Index(name="idx_1978cf254444614a", columns={"bnpc_name_3"}), @ORM\Index(name="idx_1978cf2585158c7b", columns={"items_involved_4"}), @ORM\Index(name="idx_1978cf251c1cddc1", columns={"items_involved_7"}), @ORM\Index(name="idx_1978cf25342e95c5", columns={"bnpc_name_6"}), @ORM\Index(name="idx_1978cf25f57f78f4", columns={"items_involved_1"}), @ORM\Index(name="idx_1978cf2546d8accc", columns={"rule"}), @ORM\Index(name="idx_1978cf2582784862", columns={"items_involved_0"}), @ORM\Index(name="idx_1978cf25f212bced", columns={"items_involved_5"}), @ORM\Index(name="idx_1978cf25aa4a0066", columns={"bnpc_name_1"}), @ORM\Index(name="idx_1978cf25da20f4e9", columns={"bnpc_name_4"}), @ORM\Index(name="idx_1978cf254329a553", columns={"bnpc_name_7"})})
 * @ORM\Entity
 */
class CompanyLeve
{
     ...
     * @ORM\SequenceGenerator(sequenceName="company_leve_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
     ...
     * @var int|null
     *
     * @ORM\Column(name="route_point_time_0", type="bigint", nullable=true)
     */
    private $routePointTime0;

    /**
     * @var int|null
     *
     * @ORM\Column(name="route_point_time_1", type="bigint", nullable=true)
     */
    private $routePointTime1;

    /**
     * @var int|null
     *
     * @ORM\Column(name="route_point_time_2", type="bigint", nullable=true)
     */
    private $routePointTime2;

    /**
     * @var int|null
     *
     * @ORM\Column(name="route_point_time_3", type="bigint", nullable=true)
     */
    private $routePointTime3;

    /**
     * @var int|null
     *
     * @ORM\Column(name="route_point_time_4", type="bigint", nullable=true)
     */
    private $routePointTime4;

    /**
     * @var int|null
     *
     * @ORM\Column(name="route_point_time_5", type="bigint", nullable=true)
     */
    private $routePointTime5;

    /**
     * @var int|null
     *
     * @ORM\Column(name="route_point_time_6", type="bigint", nullable=true)
     */
    private $routePointTime6;

    /**
     * @var int|null
     *
     * @ORM\Column(name="route_point_time_7", type="bigint", nullable=true)
     */
    private $routePointTime7;
     ...
     * @var int|null
     *
     * @ORM\Column(name="to_do_param_0_5", type="bigint", nullable=true)
     */
    private $toDoParam05;
     ...
     * @var int|null
     *
     * @ORM\Column(name="to_do_param_1_5", type="bigint", nullable=true)
     */
    private $toDoParam15;
     ...
     * @var int|null
     *
     * @ORM\Column(name="to_do_param_2_5", type="bigint", nullable=true)
     */
    private $toDoParam25;
     ...
     * @var int|null
     *
     * @ORM\Column(name="to_do_param_3_5", type="bigint", nullable=true)
     */
    private $toDoParam35;
     ...
     * @var int|null
     *
     * @ORM\Column(name="to_do_param_4_5", type="bigint", nullable=true)
     */
    private $toDoParam45;
     ...
     * @var int|null
     *
     * @ORM\Column(name="to_do_param_5_5", type="bigint", nullable=true)
     */
    private $toDoParam55;
     ...
     * @var int|null
     *
     * @ORM\Column(name="to_do_param_6_5", type="bigint", nullable=true)
     */
    private $toDoParam65;
     ...
     * @var int|null
     *
     * @ORM\Column(name="to_do_param_7_5", type="bigint", nullable=true)
     */
    private $toDoParam75;
     ...
     * @var int|null
     *
     * @ORM\Column(name="rule_param", type="integer", nullable=true)
     */
    private $ruleParam;
     ...
     * @var CompanyLeveRule
     *
     * @ORM\ManyToOne(targetEntity="CompanyLeveRule")
     * @ORM\JoinColumns({
    ...
    public function getRoutePointTime0(): ?string
    {
        return $this->routePointTime0;
    }

    public function setRoutePointTime0(?string $routePointTime0): self
    {
        $this->routePointTime0 = $routePointTime0;

        return $this;
    }

    public function getRoutePointTime1(): ?string
    {
        return $this->routePointTime1;
    }

    public function setRoutePointTime1(?string $routePointTime1): self
    {
        $this->routePointTime1 = $routePointTime1;

        return $this;
    }

    public function getRoutePointTime2(): ?string
    {
        return $this->routePointTime2;
    }

    public function setRoutePointTime2(?string $routePointTime2): self
    {
        $this->routePointTime2 = $routePointTime2;

        return $this;
    }

    public function getRoutePointTime3(): ?string
    {
        return $this->routePointTime3;
    }

    public function setRoutePointTime3(?string $routePointTime3): self
    {
        $this->routePointTime3 = $routePointTime3;

        return $this;
    }

    public function getRoutePointTime4(): ?string
    {
        return $this->routePointTime4;
    }

    public function setRoutePointTime4(?string $routePointTime4): self
    {
        $this->routePointTime4 = $routePointTime4;

        return $this;
    }

    public function getRoutePointTime5(): ?string
    {
        return $this->routePointTime5;
    }

    public function setRoutePointTime5(?string $routePointTime5): self
    {
        $this->routePointTime5 = $routePointTime5;

        return $this;
    }

    public function getRoutePointTime6(): ?string
    {
        return $this->routePointTime6;
    }

    public function setRoutePointTime6(?string $routePointTime6): self
    {
        $this->routePointTime6 = $routePointTime6;

        return $this;
    }

    public function getRoutePointTime7(): ?string
    {
        return $this->routePointTime7;
    }

    public function setRoutePointTime7(?string $routePointTime7): self
    {
        $this->routePointTime7 = $routePointTime7;
    ...
    public function getToDoParam05(): ?string
    {
        return $this->toDoParam05;
    }

    public function setToDoParam05(?string $toDoParam05): self
    {
        $this->toDoParam05 = $toDoParam05;

        return $this;
    }

    public function getToDoParam15(): ?string
    {
        return $this->toDoParam15;
    }

    public function setToDoParam15(?string $toDoParam15): self
    {
        $this->toDoParam15 = $toDoParam15;

        return $this;
    }

    public function getToDoParam25(): ?string
    {
        return $this->toDoParam25;
    }

    public function setToDoParam25(?string $toDoParam25): self
    {
        $this->toDoParam25 = $toDoParam25;

        return $this;
    }

    public function getToDoParam35(): ?string
    {
        return $this->toDoParam35;
    }

    public function setToDoParam35(?string $toDoParam35): self
    {
        $this->toDoParam35 = $toDoParam35;

        return $this;
    }

    public function getToDoParam45(): ?string
    {
        return $this->toDoParam45;
    }

    public function setToDoParam45(?string $toDoParam45): self
    {
        $this->toDoParam45 = $toDoParam45;

        return $this;
    }

    public function getToDoParam55(): ?string
    {
        return $this->toDoParam55;
    }

    public function setToDoParam55(?string $toDoParam55): self
    {
        $this->toDoParam55 = $toDoParam55;

        return $this;
    }

    public function getToDoParam65(): ?string
    {
        return $this->toDoParam65;
    }

    public function setToDoParam65(?string $toDoParam65): self
    {
        $this->toDoParam65 = $toDoParam65;

        return $this;
    }

    public function getToDoParam75(): ?string
    {
        return $this->toDoParam75;
    }

    public function setToDoParam75(?string $toDoParam75): self
    {
        $this->toDoParam75 = $toDoParam75;
    ...
    public function getRuleParam(): ?int
    {
        return $this->ruleParam;
    }

    public function setRuleParam(?int $ruleParam): self
    {
    ...
    public function getRule(): ?CompanyLeveRule
    {
        return $this->rule;
    }

    public function setRule(?CompanyLeveRule $rule): self
    {
        $this->rule = $rule;
