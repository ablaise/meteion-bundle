 ...
 *
 * @ORM\Table(name="currency_scrip_convert")
 * @ORM\Entity
 */
class CurrencyScripConvert
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="currency_scrip_convert_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
