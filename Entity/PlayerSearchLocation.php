 ...
 *
 * @ORM\Table(name="player_search_location")
 * @ORM\Entity
 */
class PlayerSearchLocation
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="player_search_location_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
