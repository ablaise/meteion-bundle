 ...
 * MapTransientPvPmap.
 *
 * @ORM\Table(name="map_transient_pv_pmap")
 * @ORM\Entity
 */
class MapTransientPvPmap
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="map_transient_pv_pmap_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
