 ...
 *
 * @ORM\Table(name="gc_army_expedition_trait")
 * @ORM\Entity
 */
class GcArmyExpeditionTrait
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="gc_army_expedition_trait_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
