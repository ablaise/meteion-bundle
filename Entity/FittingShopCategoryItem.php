 ...
 *
 * @ORM\Table(name="fitting_shop_category_item")
 * @ORM\Entity
 */
class FittingShopCategoryItem
{
    /**
     * @var string
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="fitting_shop_category_item_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
