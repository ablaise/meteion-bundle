 ...
 *
 * @ORM\Table(name="mjivillage_development")
 * @ORM\Entity
 */
class MjivillageDevelopment
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="mjivillage_development_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
