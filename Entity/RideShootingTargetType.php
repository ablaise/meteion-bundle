 ...
 *
 * @ORM\Table(name="ride_shooting_target_type", indexes={@ORM\Index(name="idx_9542a21f949bd553", columns={"eobj"})})
 * @ORM\Entity
 */
class RideShootingTargetType
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="ride_shooting_target_type_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
     ...
     * @var Eobj
     *
     * @ORM\ManyToOne(targetEntity="Eobj")
     * @ORM\JoinColumns({
    ...
    public function getEobj(): ?Eobj
    {
        return $this->eobj;
    }

    public function setEobj(?Eobj $eobj): self
    {
        $this->eobj = $eobj;
