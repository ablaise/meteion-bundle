 ...
 * ItemRetainerLevelUp.
 *
 * @ORM\Table(name="item_retainer_level_up")
 * @ORM\Entity
 */
class ItemRetainerLevelUp
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="item_retainer_level_up_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
