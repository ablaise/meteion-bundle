 ...
 * OpeningSystemDefine.
 *
 * @ORM\Table(name="opening_system_define")
 * @ORM\Entity
 */
class OpeningSystemDefine
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="opening_system_define_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
