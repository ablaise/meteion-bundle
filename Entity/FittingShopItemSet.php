 ...
 * FittingShopItemSet.
 *
 * @ORM\Table(name="fitting_shop_item_set")
 * @ORM\Entity
 */
class FittingShopItemSet
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="fitting_shop_item_set_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
