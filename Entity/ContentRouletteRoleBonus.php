 ...
 *
 * @ORM\Table(name="content_roulette_role_bonus", indexes={@ORM\Index(name="idx_4efaf1eb6da79f84", columns={"item_reward_type"})})
 * @ORM\Entity
 */
class ContentRouletteRoleBonus
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="content_roulette_role_bonus_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
     ...
     * @var int|null
     *
     * @ORM\Column(name="reward_amount", type="integer", nullable=true)
     */
     ...
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="item_reward_type", referencedColumnName="pk")
     * })
     */
    ...
    public function setRewardAmount(?int $rewardAmount): self
    {
    ...
    public function getItemRewardType(): ?Item
    {
        return $this->itemRewardType;
    }

    public function setItemRewardType(?Item $itemRewardType): self
    {
