 ...
 *
 * @ORM\Table(name="furniture_catalog_category")
 * @ORM\Entity
 */
class FurnitureCatalogCategory
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="furniture_catalog_category_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
