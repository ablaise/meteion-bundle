 ...
 * GatheringPointName.
 *
 * @ORM\Table(name="gathering_point_name")
 * @ORM\Entity
 */
class GatheringPointName
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="gathering_point_name_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
