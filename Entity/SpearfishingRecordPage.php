 ...
 *
 * @ORM\Table(name="spearfishing_record_page", indexes={@ORM\Index(name="idx_eaffca3294960eea", columns={"place_name"})})
 * @ORM\Entity
 */
class SpearfishingRecordPage
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="spearfishing_record_page_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
