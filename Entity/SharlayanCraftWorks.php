 ...
 * SharlayanCraftWorks.
 *
 * @ORM\Table(name="sharlayan_craft_works")
 * @ORM\Entity
 */
class SharlayanCraftWorks
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="sharlayan_craft_works_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
     ...
     * @var string|null
     *
     * @ORM\Column(name="column_3", type="string", length=1676, nullable=true)
     */
    private $column3;
