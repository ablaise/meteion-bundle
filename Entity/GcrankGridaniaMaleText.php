 ...
 *
 * @ORM\Table(name="gcrank_gridania_male_text")
 * @ORM\Entity
 */
class GcrankGridaniaMaleText
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="gcrank_gridania_male_text_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
