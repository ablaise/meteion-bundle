 ...
 * BannerDesignPreset.
 *
 * @ORM\Table(name="banner_design_preset")
 * @ORM\Entity
 */
class BannerDesignPreset
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="banner_design_preset_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
