 ...
 * GcrankLimsaMaleText.
 *
 * @ORM\Table(name="gcrank_limsa_male_text")
 * @ORM\Entity
 */
class GcrankLimsaMaleText
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="gcrank_limsa_male_text_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
