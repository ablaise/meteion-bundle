 ...
 *
 * @ORM\Table(name="mjivillage_appearance_sg")
 * @ORM\Entity
 */
class MjivillageAppearanceSg
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="mjivillage_appearance_sg_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
