 ...
 * CutsceneEventMotion.
 *
 * @ORM\Table(name="cutscene_event_motion")
 * @ORM\Entity
 */
class CutsceneEventMotion
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="cutscene_event_motion_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
