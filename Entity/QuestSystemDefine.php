 ...
 * QuestSystemDefine.
 *
 * @ORM\Table(name="quest_system_define")
 * @ORM\Entity
 */
class QuestSystemDefine
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="quest_system_define_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
