 ...
 *
 * @ORM\Table(name="sequential_event_multiple_range")
 * @ORM\Entity
 */
class SequentialEventMultipleRange
{
    /**
     * @var string
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="sequential_event_multiple_range_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
