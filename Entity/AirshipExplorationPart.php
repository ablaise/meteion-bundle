 ...
 *
 * @ORM\Table(name="airship_exploration_part")
 * @ORM\Entity
 */
class AirshipExplorationPart
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="airship_exploration_part_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
