 ...
 *
 * @ORM\Table(name="group_pose_stamp_font_color")
 * @ORM\Entity
 */
class GroupPoseStampFontColor
{
    /**
     * @var int
     *
     ...
     * @ORM\SequenceGenerator(sequenceName="group_pose_stamp_font_color_pk_seq", allocationSize=1, initialValue=1)
     */
    private $pk;
